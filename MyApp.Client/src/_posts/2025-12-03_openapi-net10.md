...
| ------------ | ----------------------- |------------------------------------------|
| `x new`      | `npx create-net`        | Create a new .NET 10 App from template   |
| `x mix`      | `npx add-in`            | Add and configure a Plugin with your App |
| `x ts`       | `npx get-dtos ts`       | Regenerate latest TypeScript DTOs        |
| `x ts <url>` | `npx get-dtos ts <url>` | Generate DTOs for a remote API           |

<template>
  <ul v-if="author.twitterUrl || author.threadsUrl || author.mastodonUrl || author.gitHubUrl" role="list" class="flex">
    <li v-if="author.twitterUrl">
